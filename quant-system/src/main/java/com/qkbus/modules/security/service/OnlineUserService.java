...
public class OnlineUserService {
    ...
    public void save(JwtUser jwtUser, String token, HttpServletRequest request) {
        ...
        try {
            onlineUser = new OnlineUser(jwtUser.getId(), jwtUser.getUsername(), jwtUser.getNickName(), job, browser, ip, address, EncryptUtils.desEncrypt(token), new Date());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public OnlineUser getUser() {
        String token = tokenProvider.getToken(WebUtil.getRequest());
        return this.getOne(properties.getOnlineKey() + token);
    }
