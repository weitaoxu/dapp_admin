...
public class RsaUtils2 {
    ...
    private static void test1(RsaKeyPair keyPair) throws Exception {
        ...
        String text1 = encryptByPublicKey(keyPair.getPublicKey(), RsaUtils2.SRC);
        String text2 = decryptByPrivateKey(keyPair.getPrivateKey(), text1);
        System.out.println("加密前：" + RsaUtils2.SRC);
        System.out.println("加密后：" + text1);
        System.out.println("解密后：" + text2);
        if (RsaUtils2.SRC.equals(text2)) {
    ...
    private static void test2(RsaKeyPair keyPair) throws Exception {
        ...
        String text1 = encryptByPrivateKey(keyPair.getPrivateKey(), RsaUtils2.SRC);
    ...
    public static String decryptByPrivateKey(String privateKeyText, String text) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("解密失败=====");
            throw new BadRequestException("网络异常请稍后再试!");
        }
